package com.yw.secondhandtrade.auth.aspect;

import com.yw.secondhandtrade.auth.annotation.FillTime;
...
public class FillTimeAspect {
     ...
     */
    @Pointcut("execution(* com.yw.secondhandtrade.auth.mapper.*.*(..)) && @annotation(com.yw.secondhandtrade.auth.annotation.FillTime)")
