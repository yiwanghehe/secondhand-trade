package com.yw.secondhandtrade.server.aspect;
...
public class FillTimeAspect {
     ...
     */
    @Pointcut("execution(* com.yw.secondhandtrade.server.mapper.*.*(..)) && @annotation(com.yw.secondhandtrade.server.annotation.FillTime)")
